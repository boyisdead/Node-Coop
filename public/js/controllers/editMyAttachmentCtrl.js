documentModule.controller('editMyAttachmentCtrl', ['$scope', '$modalInstance', 'DocumentsService', 'OthersService', function($scope, $modalInstance, DocumentsService, OthersService) {

    $scope.getDocumentData = function() {
        DocumentsService.findMyAttach($scope.params.attachmentId).success(function(data) {
